      ...
      <div className="indumentaria-container">
        <div className="instagram-button">
          ...
          >
            ...
            <span className="font-semibold">Segueix-nos a Instagram</span>
          </a>
        </div>
        ...
        <div className="indumentaria-grid">
          ...
          <div className="texto-indumentaria">
            ...
            <p>
              Descobriu la nostra col·lecció exclusiva d'indumentària esportiva.
              Dissenys únics que combinen estil i funcionalitat perquè puguis
              destacar tant a la pista com a fora.
            </p>
          </div>
